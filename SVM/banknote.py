...
print "#################################################"
print "LinearSVC C=1, loss=hinge"
...
# clf = LinearSVC(C=1, loss="hinge")
# score_plt = plot_learning_curve(clf, "LinearSVC loss=hinge", X, y.values.ravel())
# score_plt.show()

clf = SVC(kernel="poly", degree=3, coef0=1, C=5)
print "#################################################"
print "SVC kernel=poly, degree=3, coef0=1, C=5"
print "Cross validation: "
scores = cross_val(X_train, Y_train, clf)
print "10-fold cross-validation mean score: ", scores.mean()
print "10-fold cross-validation standard deviation score: ", scores.std()
...
clf = SVC(kernel="poly", degree=3, coef0=1, C=5)
score_plt = plot_learning_curve(clf, "SVC kernel=poly degree=3 coef0=1 C=5", X, y.values.ravel())
score_plt.show()


clf = SVC(kernel="rbf", gamma=5, C=0.001)
print "#################################################"
print "SVC kernel=rbf, gamma=5, C=0.001"
print "Cross validation: "
scores = cross_val(X_train, Y_train, clf)
print "10-fold cross-validation mean score: ", scores.mean()
print "10-fold cross-validation standard deviation score: ", scores.std()
...
clf = SVC(kernel="rbf", gamma=5, C=0.001)
score_plt = plot_learning_curve(clf, "SVC kernel=rbf, gamma=5, C=0.001", X, y.values.ravel())
score_plt.show()
