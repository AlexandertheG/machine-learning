...
# clf = LinearSVC(C=1, loss="hinge")
# score_plt = plot_learning_curve(clf, "LinearSVC loss=hinge", X, y)
# score_plt.show()
...
clf = SVC(kernel="poly", degree=3, coef0=1, C=5)
score_plt = plot_learning_curve(clf, "SVC kernel=poly degree=3 coef0=1 C=5", X, y)
score_plt.show()
...
clf = SVC(kernel="rbf", gamma=5, C=0.001)
score_plt = plot_learning_curve(clf, "SVC kernel=rbf, gamma=5, C=0.001", X, y)
score_plt.show()
